...
public class LockManager {
  ...
  public void addVoteList(LinkedList<Lock> lockList, HashMap<String, Integer> votes) {
  ...
  public void tryGetLocks() throws IOException{
    ...
    for (int i = 0; i < server.numOfServers; i++) {
				...
				locklist = createServerMessageLockList();
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  	            ...
  	            if(!votes.containsKey(item.getData())) {
                    ...
                    if (item.getLock() == LOCK_TYPE.WRITE) {
                      ...
                      votes.replace(item.getData(), votes.get(item.getData()) - 1);
                    }
  								} else {
